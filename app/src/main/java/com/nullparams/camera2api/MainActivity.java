...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button buttonTakePicture = findViewById(R.id.button_take_photo);
        ...
        Button buttonSwitchCamera = findViewById(R.id.button_switch_to_front);
        buttonSwitchCamera.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(context, FrontCameraActivity.class);
                startActivity(i);
            }
        });
        ...
        imageViewCheck.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(context, "Image saved to 'Android > data > com.nullparams.camera2api > files'", Toast.LENGTH_LONG).show();
                recreate();
            }
        });
    ...
    private final ImageReader.OnImageAvailableListener mOnImageAvailableListener
        ...
        public void onImageAvailable(ImageReader reader) {
            mBackgroundHandler.post(new ImageSaver(reader.acquireNextImage(), mFile, imageViewCheck, imageViewClear, mTextureView, photoPreview));
        }
    };
    ...
    private static class ImageSaver implements Runnable {
        ...
        private final ImageView mImageViewCheck;
        private final ImageView mImageViewClear;
        private final TextureView mTextureView;
        private final ImageView mPhotoPreview;

        ImageSaver(Image image, File file, ImageView imageViewCheck, ImageView imageViewClear, TextureView textureView, ImageView photoPreview) {
            mImage = image;
            mFile = file;
            mImageViewCheck = imageViewCheck;
            mImageViewClear = imageViewClear;
